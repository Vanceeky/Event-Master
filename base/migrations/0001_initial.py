# Generated by Django 5.0.4 on 2024-09-06 16:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='base.service')),
            ],
        ),
        migrations.CreateModel(
            name='PostImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.FileField(blank=True, default='/default.jpg', null=True, upload_to='service_providers')),
